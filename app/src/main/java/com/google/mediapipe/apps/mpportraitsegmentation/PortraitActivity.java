...
public class PortraitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraFacing = applicationInfo.metaData.getBoolean("cameraFacingFront", false)
    ...
    public void changeCamera(View view) {
        ...
        if(cameraFacing == CameraHelper.CameraFacing.BACK) {
        ...
        onPause();
        onResume();
        Toast.makeText(PortraitActivity.this, "已切换至" + camer_info,
